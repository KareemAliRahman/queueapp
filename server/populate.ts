...
const generateSpecialUser = async () => {
  ...
  , "address1", new Date(2021, 3,1, 9,0,0,0));
  queueRepo.createNewQueue("queue2", kareem, "organization2", "description2"
  , "address2", new Date(2021, 4,1, 9,0,0,0));
}
