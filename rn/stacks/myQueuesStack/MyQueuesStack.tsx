...
export const MyQueuesStack: React.FC<MyQueuesStackProps> = ({}) => {
  return (
    <Stack.Navigator
      ...
      initialRouteName="MyQueuesList"
    >
      <Stack.Screen
        name="MyQueuesList"
        component={MyQueuesList}
        options={({ navigation, route }: MyQueuesNavProps<"MyQueuesList">) => ({
          title: "My Queues",
          headerTitleStyle: styles.headerTitle,
          headerRight: () => (
            <TouchableOpacity onPress={() => navigation.navigate("NewQueue")}>
      ...
      <Stack.Screen
        name="MyQueueInfo"
        component={MyQueueInfo}
        options={{ title: "My Queue", headerTitleStyle: styles.headerTitle }}
      />
      <Stack.Screen
        name="NewQueue"
        component={NewQueue}
        options={{ title: "New", headerTitleStyle: styles.headerTitle }}
      />
    </Stack.Navigator>
  );
};
